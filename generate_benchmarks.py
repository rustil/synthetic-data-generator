...
def get_parser():
    ...
    parser.add_argument('--cuda', action='store',
...
def getFakeImagesVAE_ENR_PostProcess(model, model_PostProcess, number, E_max, E_min, batchsize, latent_dim,  device='cpu', thresh=0.0):
...
if model_name == "WGAN":
    ...
    for exp in range(1,nexp+1):
        ...
        if gpu:
            ...
            a = getFakeImagesGAN(model_WGAN, N, emax, emin, bsize, noise, energy, device)
